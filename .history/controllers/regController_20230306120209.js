    ...
    if (!user) {
      ...
      const mailOptions = {
       ...
       <br>
        ...
        ">
          <a href='https://sisprogress.com/message?token=${newEmail.token}'
       ...
       <br>
        ...
        <br>
        <br>
          <b><a href='https://sisprogress.com/message/message?token=${newEmail.token}'>http://45.55.36.223/message?token=${newEmail.token}</a></b>
        </center>
          `,
          attachments: [{
            filename: 'Email.png',
