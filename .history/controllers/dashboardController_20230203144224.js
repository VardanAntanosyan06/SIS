...
const dashboard = async (req, res) => {
  try {
    ...
    if (user) {
      ...
      const overAllProgressDone = myTasks.filter((e)=>  e.status === "Completed")
      const overAllProgressInProgress = myTasks.filter((e)=>  e.status === "In Progress")
      ...
      console.log(overAllProgressDone,overAllProgressInProgress.length);
