...
const verify = async (req,res)=>{
    ...
    if(item){
        ...
        <a href="http://45.55.36.223:3000/login"><button style="width:250px;heigth:60px;border:none;border-radius:10px;background:rgb(10, 185, 11);color:#fff;font-size:30px;cursor:pointer">Back to login</button></a>
       </center>
        `)
    }
