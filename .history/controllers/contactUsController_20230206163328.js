    ...
    try {
        ...
        const transporter = nodemailer.createTransport({
          ...
          const mailOptions = {
            ...
            <span>${fullName}</span>
            <span style = "font-size:30px; font-weight: bold;">    email - </span>
            <span>${phone}</span>
            <span style = "font-size:30px; font-weight: bold;"> Phone - </span>
            <span>${phone}</span>            
            <span style = "font-size:30px; font-weight: bold;"> Email - </span>
            <span>${email}</span>
            <span style = "font-size:30px; font-weight: bold;"> description - </span>
