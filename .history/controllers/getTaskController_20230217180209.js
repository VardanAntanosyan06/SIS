...
const getTasksCategory1 = async (req, res) => {
  try {
    ...
    if (user) {
      ...
      eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoyLCJlbWFpbCI6InVzZXJAZXhhbXBsZS5jb20iLCJpYXQiOjE2NzY2NDIzOTV9.C8Vdl4UUhRItoIosdK-P9EdiQArh2EkStFZ0wpVPZDI
