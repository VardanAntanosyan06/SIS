...
const verify = async (req,res)=>{
    ...
    if(item){
        ...
        <a href="http://45.55.36.223:3000/login"><button style="width:250px;heigth:30px;border:none;background:rgb(93, 63, 211);color:#fff;font-size:30px;">Back to login</button>
        </center>
        `)
    }
