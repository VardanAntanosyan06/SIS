...
const advice = [
  ...
  },
  {
    ...
    title: "Start early",
    description:
      "Begin preparing for your application well in advance of the deadline. This will give you plenty of time to gather all the necessary materials, such as transcripts, test scores, and letters of recommendation.",
    univeristyId: 2,
  },  {
    title: "Start early",
    description:
