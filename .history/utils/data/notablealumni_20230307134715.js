const notableAlumni = [
  ...
  },
  {
    ...
    description: "Michelle Obama, the former First Lady of the United States, graduated from Princeton in 1985 with a degree in sociology. She became a lawyer and advocated for education and women's rights before serving as First Lady during her husband's presidency.",
    img: "http://drive.google.com/uc?export=view&id=10-6odJKEhAaNt91sQxnFZ4-ClXTypuMT",
    univeristyId: 3,
  }, {
    name:"Sebastian Thrun",
    title: "the founder of Google X",
    description: "Sebastian Thrun, the founder of Google X, graduated from Princeton in 1994 with a Ph.D. in computer science. He has made significant contributions to the field of artificial intelligence, including the development of the self-driving car.",
    img: "http://drive.google.com/uc?export=view&id=15Pm4I4PtRPfkhtkh2sa_g5X8x_7GMf1i",
    univeristyId: 3,
  }, {
    name:"Jimmy Stewart",
    title: "the actor",
    description: "Jimmy Stewart, the actor, graduated from Princeton in 1932 with a degree in architecture. He had a successful career in Hollywood, appearing in over 80 films and winning an Academy Award for his role in 'It's a Wonderful Life.'",
    ...
    description: "Larry Page and Sergey Brin: Both co-founders of Google graduated with PhDs in computer science from Stanford in 2004. Their work at the university on the PageRank algorithm, which is the basis for Google's search engine, led to the creation of one of the world's most successful and influential companies.",
    img: "http://drive.google.com/uc?export=view&id=",
    univeristyId: 4,
  }, {
    name:"Reed Hastings",
    title: "The co-founder and CEO of Netflix",
    description: "Reed Hastings: The co-founder and CEO of Netflix, earned a master's degree in computer science from Stanford in 1988. He later founded Netflix in 1997, which has revolutionized the way people consume television and movies.",
    img: "http://drive.google.com/uc?export=view&id=",
    univeristyId: 4,
  }, {
    name:"Elon Musk",
    title: "The CEO of SpaceX and Tesla",
    description: "Elon Musk: The CEO of SpaceX and Tesla received a Ph.D. in energy physics from Stanford in 2002, but he left the program after two days as he decided to pursue his entrepreneurial ventures. He went on to found Zip2, which was sold to Compaq for almost $300 million, and later founded SpaceX, Tesla, and SolarCity.",
    img: "http://drive.google.com/uc?export=view&id=",
    univeristyId: 4,
  }, {
    name:"Phil Knight",
    title: "Nike's co-founder",
    description: "Phil Knight, Nike's co-founder, earned a master's degree in business administration from Stanford in 1962. He co-founded Blue Ribbon Sports, which later became Nike, one of the world's most successful and iconic brands.",
    img: "http://drive.google.com/uc?export=view&id=",
    univeristyId: 4,
  }, {
    name:"Herbert Hoover",
    title: "The 31st President of the United States",
    description: "Herbert Hoover: The 31st President of the United States, earned a degree in geology from Stanford in 1895. He had a successful career as a mining engineer before entering politics, serving as President from 1929 to 1933.",
    img: "http://drive.google.com/uc?export=view&id=",
    univeristyId: 4,
  }, {
    name:"Sandra Day O'Connor",
    title: "The first female justice of the United States Supreme Court",
    description: "Sandra Day O'Connor: The first female justice of the United States Supreme Court, graduated from Stanford Law School in 1952. She served as a justice from 1981 to 2006 and was known for her moderate and pragmatic approach to interpreting the law.",
    img: "http://drive.google.com/uc?export=view&id=",
    univeristyId: 4,
  }, {
    name:"Sally Ride",
    title: "The first American woman in space",
    description: "Sally Ride: The first American woman in space, earned a degree in English and physics from Stanford in 1973. She later joined NASA and flew on the space shuttle Challenger in 1983, becoming the first American woman in space.",
    img: "http://drive.google.com/uc?export=view&id=",
    univeristyId: 4,
  }, {
    name:"",
