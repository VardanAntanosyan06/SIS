...
const successMessages = [
  ...
  },
  {
    ...
    status:"Excellent",
    text:"<p>: The AI hints to us that your current progress toward your dream university needs to be improved. Thus, we encourage you to use the application more actively, follow app’s recommendations, and complete tasks promptly.</p> Keep up the exceptional work by Preparing Differently</p>"
  }
]
