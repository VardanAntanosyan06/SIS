...
const advice = [
  ...
  },
  {
    ...
    title: "Showcase your achievements",
    description: "Highlight your academic achievements, extracurricular activities, and any awards or honors you have received. This will help demonstrate your potential as a student and leader at Duke.",
    univeristyId: 6,
  },{
    title: "Get strong letters of recommendation",
    description: "Ask teachers or mentors who know you well and can speak to your academic and personal strengths to write letters of recommendation on your behalf.",
    univeristyId: 6,
  },{
    title: "Proofread and edit",
    description: "Make sure your application is error-free, and your essays are well-written and polished.",
    univeristyId: 6,
  },{
    title: "Be Honest and Genuine",
    description: "Admissions officers can often tell when an applicant is insincere. Be honest and genuine in your application, and make sure your essays reflect your personality and values.",
    univeristyId: 6,
  },{
    title: "Meet the deadline",
    description: "Submit your application on or before the deadline to avoid any delays or complications.",
    univeristyId: 6,
  },{
    title: "Keep in touch",
    description: "After you submit your application, keep in touch with the admissions office. If you have any updates or changes to your application, let them know.",
    univeristyId: 6,
  },{
    title: "Make the best use of SIS Progress",
    description: "The world's first AI-empowered Edtech startup that will advise you on precisely what you need to plan and possess before applying to U.S. universities across five core indices: Academics, Standardized Tests, Extracurriculars, Career/School Choices, and Personal Development. It will also track your progress toward admission by relying on previous successful university applicants' data.",
    ...
    description: "if the university offers an interview, it is an excellent opportunity to make an even stronger impression and shows that you are a good fit for Duke. Be prepared to answer questions about your qualifications and goals, and ask any questions you may have about the university.",
    univeristyId: 6,
  },{
    title: "Research the school",
    description: "Research Dartmouth College to understand its academic programs, extracurricular activities, and community. Familiarize yourself with the college's mission, values, and what sets it apart from other institutions.",
    univeristyId: 7,
  },{
    title: "Tailor your application",
    description: "Show how you fit with Dartmouth College's mission and values. Tailor your application essays and activities list to demonstrate how your interests and experiences align with the school.",
    univeristyId: 7,
  },{
    title: "Get good grades",
    description: "A strong academic record is essential for admission to Dartmouth College. Maintain a high GPA and take challenging courses that align with your desired major.",
    univeristyId: 7,
  },{
    title: "Show leadership",
    description: "Dartmouth College values leadership, so highlight any leadership roles you have held in your extracurricular activities, community service, and work experience.",
    univeristyId: 7,
  },{
    title: "Get strong letters of recommendation",
    description: "Ask teachers, counselors, or other adults who know you well to write you letters of recommendation. Make sure to give them enough time to write a thoughtful letter and provide them with information about the school and what you are looking for in a letter.",
    univeristyId: 7,
  },{
    title: "Make the best use of SIS Progress",
    description: "The world's first AI-empowered Edtech startup to advise you on precisely what you need to plan and possess before applying to U.S. universities. It will also track your progress toward admission by relying on previous successful university applicants' data.",
    ...
    description: "Dartmouth College is looking for well-rounded students who can contribute to the campus community. Your essays and interviews are an excellent opportunity to showcase your unique personality, interests, and talents.",
    univeristyId: 7,
  },{
    title: "Be Authentic",
    description: "Be true to yourself, and don't try to be someone you are not. Admissions officers can tell when an applicant is trying to fit a mold or is not being genuine.",
    univeristyId: 7,
  },{
    title: "Proofread",
    description: "Make sure to proofread your application for any grammar or spelling errors. It's also a good idea to have someone else read over your application to catch any mistakes you may have missed.",
    univeristyId: 7,
  },{
    title: "Finally, apply for Early Decision",
    description: "Early Decision applicants have a higher acceptance rate, demonstrating a clear commitment to the school. Besides, make sure to submit your application before the deadline to ensure that it is considered.",
    univeristyId: 7,
  // },
  {
  //   title: "",
